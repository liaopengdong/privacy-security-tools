const TOOLS = {"password-generator": {"title": "Password Generator", "desc": "Generate random passwords with length and character options.", "category": "Generators", "kind": "password", "fields": [{"id": "length", "label": "Length", "type": "number", "value": 20}, {"id": "upper", "label": "Uppercase", "type": "select", "value": "", "options": [["yes", "Yes"], ["no", "No"]]}, {"id": "numbers", "label": "Numbers", "type": "select", "value": "", "options": [["yes", "Yes"], ["no", "No"]]}, {"id": "symbols", "label": "Symbols", "type": "select", "value": "", "options": [["yes", "Yes"], ["no", "No"]]}], "manual": false}, "passphrase-generator": {"title": "Passphrase Generator", "desc": "Generate memorable passphrases from a local word list.", "category": "Generators", "kind": "passphrase", "fields": [{"id": "words", "label": "Word count", "type": "number", "value": 4}, {"id": "separator", "label": "Separator", "type": "text", "value": "-"}], "manual": false}, "sha256-hash-generator": {"title": "SHA-256 Hash Generator", "desc": "Generate SHA-256 hash from text locally.", "category": "Hashing", "kind": "sha256", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Hello world"}], "manual": false}, "file-hash-checker": {"title": "File Hash Checker", "desc": "Generate SHA-256 hash for an uploaded file in the browser.", "category": "Hashing", "kind": "fileHash", "fields": [{"id": "file", "label": "File", "type": "file", "value": "", "accept": "*/*"}], "manual": true}, "random-number-generator": {"title": "Random Number Generator", "desc": "Generate cryptographically strong random numbers in a range.", "category": "Generators", "kind": "randomNumber", "fields": [{"id": "min", "label": "Min", "type": "number", "value": 1}, {"id": "max", "label": "Max", "type": "number", "value": 100}, {"id": "count", "label": "Count", "type": "number", "value": 5}], "manual": false}, "uuid-generator": {"title": "UUID Generator", "desc": "Generate UUID v4 identifiers.", "category": "Generators", "kind": "uuid", "fields": [{"id": "count", "label": "Count", "type": "number", "value": 5}], "manual": false}, "jwt-decoder": {"title": "JWT Decoder", "desc": "Decode JWT header and payload locally without verifying signatures.", "category": "Inspection", "kind": "jwt", "fields": [{"id": "token", "label": "JWT", "type": "textarea", "value": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjMifQ.signature"}], "manual": false}, "secret-redactor": {"title": "Secret Redactor", "desc": "Redact emails, phone numbers, tokens, and long secrets from text.", "category": "Redaction", "kind": "redact", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Email jane@example.com and token sk_test_123456789abcdef"}], "manual": false}, "entropy-estimator": {"title": "Password Entropy Estimator", "desc": "Estimate password search space and rough entropy.", "category": "Inspection", "kind": "entropy", "fields": [{"id": "password", "label": "Password", "type": "text", "value": "CorrectHorseBatteryStaple42!"}], "manual": false}, "checksum-calculator": {"title": "Simple Checksum Calculator", "desc": "Calculate a simple additive checksum for text.", "category": "Hashing", "kind": "checksum", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Hello world"}], "manual": false}, "url-safety-notes": {"title": "URL Safety Notes", "desc": "Parse a URL and show host, protocol, and suspicious signals.", "category": "Inspection", "kind": "urlSafety", "fields": [{"id": "url", "label": "URL", "type": "text", "value": "https://example.com/login?next=dashboard"}], "manual": false}, "base64-inspector": {"title": "Base64 Inspector", "desc": "Encode, decode, and inspect Base64 text.", "category": "Inspection", "kind": "base64", "fields": [{"id": "text", "label": "Text or Base64", "type": "textarea", "value": "Hello world"}], "manual": false}, "strong-password-generator": {"title": "Strong Password Generator", "desc": "Generate a strong random password with configurable length and character sets.", "category": "Generators", "kind": "password", "fields": [{"id": "length", "label": "Length", "type": "number", "value": 20}, {"id": "upper", "label": "Uppercase", "type": "select", "value": "yes", "options": [["yes", "Yes"], ["no", "No"]]}, {"id": "numbers", "label": "Numbers", "type": "select", "value": "yes", "options": [["yes", "Yes"], ["no", "No"]]}, {"id": "symbols", "label": "Symbols", "type": "select", "value": "yes", "options": [["yes", "Yes"], ["no", "No"]]}], "manual": false}, "memorable-passphrase-generator": {"title": "Memorable Passphrase Generator", "desc": "Generate a random word-based passphrase with a custom separator.", "category": "Generators", "kind": "passphrase", "fields": [{"id": "words", "label": "Words", "type": "number", "value": 5}, {"id": "separator", "label": "Separator", "type": "text", "value": "-"}], "manual": false}, "random-integer-generator": {"title": "Random Integer Generator", "desc": "Generate random integers within a selected range using browser crypto APIs.", "category": "Generators", "kind": "randomNumber", "fields": [{"id": "min", "label": "Minimum", "type": "number", "value": 1}, {"id": "max", "label": "Maximum", "type": "number", "value": 100}, {"id": "count", "label": "Count", "type": "number", "value": 10}], "manual": false}, "uuid-list-generator": {"title": "UUID List Generator", "desc": "Generate one or more browser-created UUID values for testing and records.", "category": "Generators", "kind": "uuid", "fields": [{"id": "count", "label": "UUID count", "type": "number", "value": 5}], "manual": false}, "text-sha256-generator": {"title": "Text SHA-256 Generator", "desc": "Calculate a SHA-256 hash for text in the browser.", "category": "Hashing", "kind": "sha256", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Hash this text"}], "manual": false}, "jwt-payload-decoder": {"title": "JWT Payload Decoder", "desc": "Decode JWT header and payload locally without verifying the signature.", "category": "Inspection", "kind": "jwt", "fields": [{"id": "token", "label": "JWT", "type": "textarea", "value": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjMifQ.signature"}], "manual": false}, "secret-text-redactor": {"title": "Secret Text Redactor", "desc": "Redact emails, phone numbers, tokens, and long secret-like values from text.", "category": "Redaction", "kind": "redact", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Contact alex@example.com or call 555-123-4567 with token sk_live_123456789abcdef."}], "manual": false}, "base64-encoder-decoder": {"title": "Base64 Encoder Decoder", "desc": "Encode text to Base64 and attempt to decode Base64 input locally.", "category": "Inspection", "kind": "base64", "fields": [{"id": "text", "label": "Text or Base64", "type": "textarea", "value": "Browser tools"}], "manual": false}, "advanced-password-generator": {"title": "Advanced Password Generator", "desc": "Generate random passwords with length and character options. Use this focused variant for advanced workflows and long-tail search scenarios.", "category": "Generators", "kind": "password", "fields": [{"id": "length", "label": "Length", "type": "number", "value": 20}, {"id": "upper", "label": "Uppercase", "type": "select", "value": "", "options": [["yes", "Yes"], ["no", "No"]]}, {"id": "numbers", "label": "Numbers", "type": "select", "value": "", "options": [["yes", "Yes"], ["no", "No"]]}, {"id": "symbols", "label": "Symbols", "type": "select", "value": "", "options": [["yes", "Yes"], ["no", "No"]]}], "manual": false}, "quick-passphrase-generator": {"title": "Quick Passphrase Generator", "desc": "Generate memorable passphrases from a local word list. Use this focused variant for quick workflows and long-tail search scenarios.", "category": "Generators", "kind": "passphrase", "fields": [{"id": "words", "label": "Word count", "type": "number", "value": 4}, {"id": "separator", "label": "Separator", "type": "text", "value": "-"}], "manual": false}, "planning-sha256-hash-generator": {"title": "Planning SHA-256 Hash Generator", "desc": "Generate SHA-256 hash from text locally. Use this focused variant for planning workflows and long-tail search scenarios.", "category": "Hashing", "kind": "sha256", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Hello world"}], "manual": false}, "mobile-file-hash-checker": {"title": "Mobile File Hash Checker", "desc": "Generate SHA-256 hash for an uploaded file in the browser. Use this focused variant for mobile workflows and long-tail search scenarios.", "category": "Hashing", "kind": "fileHash", "fields": [{"id": "file", "label": "File", "type": "file", "value": "", "accept": "*/*"}], "manual": true}, "small-business-random-number-generator": {"title": "Small Business Random Number Generator", "desc": "Generate cryptographically strong random numbers in a range. Use this focused variant for small business workflows and long-tail search scenarios.", "category": "Generators", "kind": "randomNumber", "fields": [{"id": "min", "label": "Min", "type": "number", "value": 1}, {"id": "max", "label": "Max", "type": "number", "value": 100}, {"id": "count", "label": "Count", "type": "number", "value": 5}], "manual": false}, "creator-uuid-generator": {"title": "Creator UUID Generator", "desc": "Generate UUID v4 identifiers. Use this focused variant for creator workflows and long-tail search scenarios.", "category": "Generators", "kind": "uuid", "fields": [{"id": "count", "label": "Count", "type": "number", "value": 5}], "manual": false}, "student-jwt-decoder": {"title": "Student JWT Decoder", "desc": "Decode JWT header and payload locally without verifying signatures. Use this focused variant for student workflows and long-tail search scenarios.", "category": "Inspection", "kind": "jwt", "fields": [{"id": "token", "label": "JWT", "type": "textarea", "value": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjMifQ.signature"}], "manual": false}, "team-secret-redactor": {"title": "Team Secret Redactor", "desc": "Redact emails, phone numbers, tokens, and long secrets from text. Use this focused variant for team workflows and long-tail search scenarios.", "category": "Redaction", "kind": "redact", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Email jane@example.com and token sk_test_123456789abcdef"}], "manual": false}, "audit-entropy-estimator": {"title": "Audit Password Entropy Estimator", "desc": "Estimate password search space and rough entropy. Use this focused variant for audit workflows and long-tail search scenarios.", "category": "Inspection", "kind": "entropy", "fields": [{"id": "password", "label": "Password", "type": "text", "value": "CorrectHorseBatteryStaple42!"}], "manual": false}, "checklist-checksum-calculator": {"title": "Checklist Simple Checksum Calculator", "desc": "Calculate a simple additive checksum for text. Use this focused variant for checklist workflows and long-tail search scenarios.", "category": "Hashing", "kind": "checksum", "fields": [{"id": "text", "label": "Text", "type": "textarea", "value": "Hello world"}], "manual": false}, "campaign-url-safety-notes": {"title": "Campaign URL Safety Notes", "desc": "Parse a URL and show host, protocol, and suspicious signals. Use this focused variant for campaign workflows and long-tail search scenarios.", "category": "Inspection", "kind": "urlSafety", "fields": [{"id": "url", "label": "URL", "type": "text", "value": "https://example.com/login?next=dashboard"}], "manual": false}, "batch-base64-inspector": {"title": "Batch Base64 Inspector", "desc": "Encode, decode, and inspect Base64 text. Use this focused variant for batch workflows and long-tail search scenarios.", "category": "Inspection", "kind": "base64", "fields": [{"id": "text", "label": "Text or Base64", "type": "textarea", "value": "Hello world"}], "manual": false}};
